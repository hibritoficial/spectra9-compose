...
export default function HeroProduct() {
  return (
    <section className="hero-product relative w-full min-h-screen flex items-center overflow-hidden">
      ...
      <div className="hero-product-grid relative z-10 w-full max-w-[1440px] mx-auto px-12 py-32 items-center">
        {/* Text */}
